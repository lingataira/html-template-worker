...
<head>
    ...
    <link href="/assets/supersleep/css/styles.css" rel="stylesheet">
</head>
...
<body data-variant="43991132668094" data-product="8073276784830" data-max-quantity="10" data-id="SPREMPK28UB"
        ...
        <div class="container-xl">
                    ...
                    <nav class="row navbar bg-body-tertiary">
                        <div class="py-2 px-4">
                            <a class="navbar-brand" href="https://www.superpatch.com/" target="_blank">
                                <img src="/assets/supersleep/images/superpatch-logo.svg" alt="Superpatch Logo"
            ...
            <div id="rem-purchase-div" class="rem-patch-section row px-lg-5 pb-3">
                ...
                <div class="col-12 col-lg-6 d-flex align-items-center">
                    <img src="/assets/supersleep/images/rem-pdp.png" alt="Man Sleeping" class="img-fluid">
                </div>
            ...
            <div class="logos-section row pb-lg-5">
                <div class="col-lg-3 col-6 my-4 my-lg-0 d-flex justify-content-center">
                    <img src="/assets/supersleep/images/drug-free.png" alt="Drug Free" class="img-fluid">
                </div>
                <div class="col-lg-3 col-6 my-4 my-lg-0 d-flex justify-content-center">
                    <img src="/assets/supersleep/images/clinical-trials.png" alt="Amazing Clinical Trial Results" class="img-fluid">
                </div>
                <div class="col-lg-3 col-6 my-4 my-lg-0 d-flex justify-content-center">
                    <img src="/assets/supersleep/images/incredible-benefits.png" alt="Incredible Benefits" class="img-fluid">
                </div>
                <div class="col-lg-3 col-6 my-4 my-lg-0 d-flex justify-content-center">
                    <img src="/assets/supersleep/images/made-in-usa.png" alt="Made In The USA" class="img-fluid">
                </div>
            </div>
            ...
            <div class="about-rem-section pb-0">
                <div class="good-sleep row">
                    <div class="col-lg-6 col-md-12 light-gray-bg py-5 p-lg-5">
                        ...
                        <img src="/assets/supersleep/images/why-good-sleep-is-essential.png" alt="Why Good Sleep Is Essential"
                ...
                <div class="choose-rem-patch row">
                    ...
                    <div class="col-lg-6 col-md-12 py-5 p-lg-5">
                        ...
                        <img src="/assets/supersleep/images/mother-daughter.png" alt="Mother Daughter"
                            class="img-fluid mt-4 d-flex d-lg-none">
                ...
                <div class="amazing-results row">
                    <div class="col-lg-6 col-md-12 light-gray-bg py-5 p-lg-5">
                        ...
                        <img src="/assets/supersleep/images/amazing-results-with-rem-super-patch.png"
                ...
                <div class="affordable-effective row">
                    ...
                    <div class="info-text col-lg-6 col-md-12">
                        <h3 class="fw-bolder fs-4">Why Choose REM Super Patch™?</h3>
                        <img src="/assets/supersleep/images/family.png" alt="Family" class="img-fluid mt-4 d-flex d-lg-none">
                    ...
                    <div class="col-12">
                        <div class="owl-carousel owl-theme advisory-board">
                            <div class="item card-item light-gray-bg">
                                <img src="/assets/supersleep/images/anna-toker.png" alt="Dr. Anna Toker" class="img-fluid">
                                <div class="row p-4">
                            ...
                            <div class="item card-item light-gray-bg">
                                <img src="/assets/supersleep/images/alexander-schauss.png" alt="Alexander G. Schauss" class="img-fluid">
                                <div class="row p-4">
                                    <div class="col-md-12 text-center">
                            ...
                            <div class="item card-item light-gray-bg">
                                <img src="/assets/supersleep/images/marc-boff.png" alt="Dr. Marc H Boff" class="img-fluid">
                                <div class="row p-4">
                                    <div class="col-md-12 text-center">
            ...
            <div class="rem-patch-section row px-lg-5 pb-3">
                ...
                <div class="col-12 col-lg-6">
                    <img src="/assets/supersleep/images/rem-product.png" alt="REM Superpatch" class="rem-product img-fluid">
                </div>
                <div class="col-12 col-lg-6">
                    <h2 class="fw-bolder display-2 d-none d-lg-block mb-0">REM</h2>
                    <h3 class="fw-bold d-none d-lg-block mb-0">Sleep Deeply</h3>
            ...
            <div class="about-rem-section">
                <div class="better-sleep-health row">
                    <div class="info-text light-gray-bg col-lg-6 col-md-12">
                        ...
                        <img src="/assets/supersleep/images/couple-mobile.jpg" alt="Couple" class="img-fluid mt-4 d-flex d-lg-none">
                ...
                <div class="transforming-sleep row">
                    ...
                    <div class="info-text light-gray-bg col-lg-6 col-md-12">
                        ...
                        <img src="/assets/supersleep/images/woman-vibrotactile-tech.png" alt="Woman Vibrotactile Technology"
                            class="img-fluid mt-4 d-flex d-lg-none">
            ...
            <div class="about-rem-section pb-0">
                <div class="transform-life row">
                    ...
                    <div class="info-text light-gray-bg col-lg-6 col-md-12">
                        ...
                        <img src="/assets/supersleep/images/family-02.png" alt="Family" class="img-fluid mt-4 d-flex d-lg-none">
                ...
                <div class="no-risk row">
                    <div class="info-text col-lg-6 col-md-12">
                        ...
                        <img src="/assets/supersleep/images/teammates.png" alt="Teammates" class="img-fluid mt-4 d-flex d-lg-none">
                ...
                <div class="col-lg-7 offset-lg-4 text-center">
                    ...
                    <div class="row d-none d-md-flex">
                        <div class="col-md-4 mb-3">
                            <div class="how-it-works">
                                <div class="row align-items-center">
                                    <img src="/assets/supersleep/images/how-it-works-open-2.webp" alt="Superpatch" class="img-fluid">
                        ...
                        <div class="col-md-4 mb-3">
                            <div class="how-it-works">
                                <div class="row align-items-center">
                                    <img src="/assets/supersleep/images/how-it-works-peel-2.webp" alt="Superpatch" class="img-fluid">
                        ...
                        <div class="col-md-4 mb-3">
                            <div class="how-it-works">
                                <div class="row align-items-center">
                                    <img src="/assets/supersleep/images/how-it-works-stick-2.webp" alt="Superpatch" class="img-fluid">
                    ...
                    <div class="d-md-none">
                        <div class="owl-carousel owl-theme wear-tech">
                            ...
                            <div class="item pt-5 px-5">
                                <div class="how-it-works">
                                    <div class="row align-items-center">
                                        <img src="/assets/supersleep/images/how-it-works-stick-2.webp" alt="Superpatch"
                                            class="img-fluid">
                                        <p class="mt-3">Stick it on your forearm and start enjoying the benefits
                                            instantly!</p>
                                    </div>
                ...
                <div class="col-lg-10 offset-lg-1 col-xl-8 offset-xl-2">
                    <div class="row">
                        <div
                            ...
                            <img src="/assets/supersleep/images/drug-free-bnw.jpg" alt="Drug Free" class="img-fluid px-0">
                        </div>
                        <div
                            class="col-lg-3 col-6 my-4 d-flex align-items-center justify-content-center justify-content-lg-start">
                            <img src="/assets/supersleep/images/fall-asleep-faster.jpg" alt="Fall Asleep Faster" class="img-fluid px-0">
                        </div>
                        <div
                            class="col-lg-3 col-6 my-4 d-flex align-items-center justify-content-center justify-content-lg-start">
                            <img src="/assets/supersleep/images/wake-up-less-at-night.jpg" alt="Wake Up Less At Night"
                                class="img-fluid px-0">
                        </div>
                        <div
                            class="col-lg-3 col-6 my-4 d-flex align-items-center justify-content-center justify-content-lg-start">
                            <img src="/assets/supersleep/images/wake-up-refreshed.jpg" alt="Wake Up Refreshed" class="img-fluid px-0">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row about-rem-section pt-5 pb-0 py-lg-5">
                <div class="col-lg-10 offset-lg-1 col-xl-8 offset-xl-2">
                    <div class="row choose-rem-patch">
                        <div class="col-12 col-lg-6 d-flex align-items-center">
                            <img src="/assets/supersleep/images/Sleep_patch_02.jpg" alt="Why Choose REM Super Patch" class="img-fluid">
                        </div>
                        <div class="col-lg-6 col-md-12 py-5 p-lg-5">
        ...
        <div class="container-fluid" id="remShopSection">
            <div class="row rem-patch-section pt-5 pt-lg-0">
                <div class="col-lg-10 offset-lg-1 col-xl-8 offset-xl-2">
                    <div class="row">
                        <div class="col-12 col-lg-6 d-flex align-items-center">
                            <img src="/assets/supersleep/images/Sleep_patch_package_01.jpg" alt="Sleep Patch Package" class="img-fluid">
                        </div>
                    ...
                    <div class="col-lg-10 offset-lg-1 col-xl-8 offset-xl-2">
                        <div class="row">
                            <div class="col-md-4 rem-patch-bg">
                                <img src="/assets/supersleep/images/rem-patch-peel.png" alt="REM" class="img-fluid">
                            </div>
                            <div class="col-md-8">
                                <div class="row">
                                    <div class="col-md-12">
                                ...
                                <div class="row text-center">
                                    <div class="col-md-4">
                                        <div class="how-it-works">
                                            <div class="row align-items-center justify-content-center">
                                                <img src="/assets/supersleep/images/how-it-works-open-2.webp" alt="Superpatch"
                                                    class="img-fluid">
                                                <p class="mt-3">Open your Super Patch Pack and take out one patch.</p>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="how-it-works">
                                            <div class="row align-items-center justify-content-center">
                                                <img src="/assets/supersleep/images/how-it-works-peel-2.webp" alt="Superpatch"
                                                    class="img-fluid">
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 mt-4">
                                <div class="owl-carousel owl-theme advisory-board">
                                    ...
                                    <div class="item card-item light-gray-bg">
                                        <img src="/assets/supersleep/images/alexander-schauss.png" alt="Alexander G. Schauss"
                                            class="img-fluid">
                                        <div class="row p-4">
                                            <div class="col-md-12 text-center">
                                                <h4 class="fs-5 fw-bolder">Alexander G. Schauss</h4>
    ...
    <script src="/assets/supersleep/js/jquery.min.js"></script>
    <script src="/assets/supersleep/js/owl.carousel.min.js"></script>
    <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/js/bootstrap.bundle.min.js"
        integrity="sha384-YvpcrYf0tY3lHB60NNkmXc5s9fDVZLESaAA55NDzOxhy9GkcIdslK1eN7N6jIeHz"
        crossorigin="anonymous"></script>
    <script src="/assets/supersleep/js/scripts.js"></script>
</body>
